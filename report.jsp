...
<% weather a = (weather)request.getAttribute("data"); %>
<body>
     ...
     <form action="report"  class="searchInput">
        ...
        <div class="weatherDetails">
            <div class="weatherIcon">
                ...
                <h2><%=a.getTemperatureCelsius()%> °C</h2>
                 <input type="hidden" id="wc" value="<%=a.getWeatherCondition()%>"> 
            </div>
            
            <div class="cityDetails">        
                <div class="desc"><strong><%=a.getCity()%></strong></div>
                <div class="date"><%=a.getDate()%></div>
            </div>
